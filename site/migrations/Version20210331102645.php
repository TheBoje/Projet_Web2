 ...
 */
final class Version20210331102645 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE im2021_product (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, label VARCHAR(255) NOT NULL COLLATE BINARY, quantity INTEGER NOT NULL, price DOUBLE PRECISION NOT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__im2021_product AS SELECT id, label, price, quantity FROM "im2021_product"');
        $this->addSql('DROP TABLE "im2021_product"');
        $this->addSql('CREATE TABLE "im2021_product" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, label VARCHAR(255) NOT NULL, quantity INTEGER NOT NULL, price INTEGER NOT NULL)');
        $this->addSql('INSERT INTO "im2021_product" (id, label, price, quantity) SELECT id, label, price, quantity FROM __temp__im2021_product');
        $this->addSql('DROP TABLE __temp__im2021_product');
    }
}
