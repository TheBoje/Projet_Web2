 ...
 */
final class Version20210404122905 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE im2021_product (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, label VARCHAR(255) NOT NULL COLLATE BINARY, quantity INTEGER NOT NULL, price NUMERIC(7, 2) NOT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE "im2021_product"');
        $this->addSql('CREATE TABLE "im2021_product" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, label VARCHAR(255) NOT NULL, quantity INTEGER NOT NULL, price NUMERIC(5, 2) NOT NULL)');
